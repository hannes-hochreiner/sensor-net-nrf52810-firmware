...
impl Radio {
    ...
    pub fn init_transmission(&mut self) {
        ...
        self.radio
            .base0
            .write(|w| unsafe { w.base0().bits(0xABCDABCD) });
    ...
    pub fn start_transmission(&mut self, data: &[&[u8]]) {
        ...
        self.radio.intenset.write(|w| w.disabled().bit(true));
        // set packet pointer
        self.radio
            .packetptr
            .write(|w| unsafe { w.packetptr().bits((&self.packet as *const u8) as u32) });
    ...
    pub fn init_reception(&self) {
        ...
        self.radio
            .frequency
            .write(|w| unsafe { w.frequency().bits(90) });
        ...
        self.radio
            .base1
            .write(|w| unsafe { w.base1().bits(0xABCDABCD) });

        // PREFIX0
        // AP0: 0xDA
        self.radio
            .prefix0
            .write(|w| unsafe { w.ap0().bits(0xDA).ap1().bits(0xEF) });
        ...
        self.radio
            .rxaddresses
            .write(|w| w.addr0().bit(true).addr1().bit(true));
    ...
    pub fn is_ready(&self) -> bool {
        self.radio.events_ready.read().events_ready().variant()
            == nrf52810_pac::radio::events_ready::EVENTS_READY_A::GENERATED
    }
    ...
    pub fn is_address(&self) -> bool {
        self.radio.events_address.read().events_address().variant()
            == nrf52810_pac::radio::events_address::EVENTS_ADDRESS_A::GENERATED
    }
    ...
    pub fn is_payload(&self) -> bool {
        self.radio.events_payload.read().events_payload().variant()
            == nrf52810_pac::radio::events_payload::EVENTS_PAYLOAD_A::GENERATED
    }
    ...
    pub fn start_rssi(&self) {
        self.radio
            .tasks_rssistart
            .write(|w| w.tasks_rssistart().bit(true));
    }

    pub fn stop_rssi(&self) {
        self.radio
            .tasks_rssistop
            .write(|w| w.tasks_rssistop().bit(true));
    }
    ...
    pub fn event_reset_all(&self) {
        self.radio
            .events_ready
            .write(|w| w.events_ready().not_generated());
        self.radio
            .events_address
            .write(|w| w.events_address().not_generated());
        self.radio
            .events_payload
            .write(|w| w.events_payload().not_generated());
        self.radio
            .events_end
            .write(|w| w.events_end().not_generated());
        self.radio
            .events_disabled
            .write(|w| w.events_disabled().not_generated());
        self.radio
            .events_devmatch
            .write(|w| w.events_devmatch().not_generated());
        self.radio
            .events_devmiss
            .write(|w| w.events_devmiss().not_generated());
        self.radio
            .events_bcmatch
            .write(|w| w.events_bcmatch().not_generated());
        self.radio
            .events_crcok
            .write(|w| w.events_crcok().not_generated());
        self.radio
            .events_crcerror
            .write(|w| w.events_crcerror().not_generated());
    }
